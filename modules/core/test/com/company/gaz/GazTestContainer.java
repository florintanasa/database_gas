...
public class GazTestContainer extends TestContainer {

    public GazTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/gaz/app.properties",
    ...
    public static class Common extends GazTestContainer {

        public static final GazTestContainer.Common INSTANCE = new GazTestContainer.Common();
