...
@NamePattern("%s %s %s|tipTarif,denumireTarif,tarif")
@Table(name = "GAZ_TARIFE_RACORDARE_FIXE")
@Entity(name = "gaz$TarifeRacordareFixe")
public class TarifeRacordareFixe extends StandardEntity {
    private static final long serialVersionUID = -8099564421823111405L;
    ...
    @NotNull
    @Column(name = "DENUMIRE_TARIF", nullable = false, length = 50)
    protected String denumireTarif;
    ...
    public void setDenumireTarif(String denumireTarif) {
        this.denumireTarif = denumireTarif;
    }

    public String getDenumireTarif() {
        return denumireTarif;
    }
